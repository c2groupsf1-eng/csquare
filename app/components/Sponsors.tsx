...
export default function Sponsors() {
  ...
  <h2 className="text-3xl font-bold text-yellow-500 mb-8 text-center">Sponsors</h2>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 items-center justify-items-center">
        {sponsors.map((s, i) => (
            <div key={i} className="sponsor-logo p-4 bg-yellow-300 rounded-xl shadow hover:scale-105 transition">

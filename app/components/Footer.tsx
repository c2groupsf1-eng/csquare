...
export default function Footer() {
  ...
  <footer className="bg-white/80 py-6 mt-16 shadow-inner">
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between px-4">
        <div>
          <span className="font-bold text-black">C² Racing</span> &copy; {new Date().getFullYear()}
        </div>
        <div className="flex gap-4 mt-2 md:mt-0">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener" className="hover:text-black">Twitter</a>
        </div>
      </div>
    </footer>
  );
